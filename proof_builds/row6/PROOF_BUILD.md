...
### Scholarly retrieval proof harness

- Claim: The retrieval system is a local research evidence machine, not a generic chatbot wrapper.
- Input: local corpus, query, retrieval configuration, and citation-support rule
- Operation: retrieve from corpus, score source support, validate citation relation, and expose uncertainty
- Expected output: traceable evidence packet and supported / weak / contradicted / unsupported claim state
- Verification check: run one query and show corpus path, retrieved passages, support label, and abstention rule
