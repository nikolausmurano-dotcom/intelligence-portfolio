...
A project is production-complete only when it can be used, checked, reproduced, and defended without relying on private intent, missing evidence, or unverified completion language.

## Blocking Gates

- **G1 - Purpose and user locked**: Public page states what the project is, whom it serves, and what concrete work it performs.
...
This control plane does not manufacture evidence. It records the present production state and identifies the files, reviews, and checks required to promote a project honestly.
